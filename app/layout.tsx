...
export const metadata: Metadata = {
  ...
  description: 'Get personalized fashion advice, outfit recommendations and style tips from our AI-powered chatbot. Features include color coordination, instant styling tips, and outfit generation.',
  keywords: 'AI fashion stylist, personal style assistant, outfit recommendations, color coordination, fashion chatbot',
  openGraph: {
    title: 'VogueLens AI - Your AI Fashion Stylist',
    description: 'Get personalized fashion advice and outfit recommendations from our AI stylist',
    type: 'website',
...
const jsonLd = {
  ...
  description: "Get personalized fashion advice, outfit recommendations and style tips from our AI-powered chatbot.",
    ...
    itemListElement: [
      {
        ...
        description: "Get personalized fashion advice tailored to your style and preferences"
      },
      {
        "@type": "ListItem",
        position: 2,
        name: "Color Coordination",
        description: "Discover perfect color combinations that complement your wardrobe"
      },
      {
        "@type": "ListItem",
        position: 3,
      ...
      },
      {
        ...
        description: "Create complete outfits from your existing wardrobe or with new pieces"
      }
    ]
  },
  howTo: {
